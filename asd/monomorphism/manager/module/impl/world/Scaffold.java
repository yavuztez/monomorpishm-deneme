...
public class Scaffold extends Module {
   ...
   public q_ setStackToPlace() {
      ...
      if (block.a() != null && !(block.a() instanceof oZ)) {
         block = null;
      }
      ...
      for(short g = 0; g < 9; ++g) {
         if (getThePlayer().bN.a(g + 36).b() && getThePlayer().bN.a(g + 36).a().a() instanceof oZ && getThePlayer().bN.a(g + 36).a().l != 0 && block.a() instanceof oZ && getThePlayer().bN.a(g + 36).a().l >= block.l) {
            slot = g;
