...
public class RenderUtil {
   ...
   public static void roundedRectCustom(double x, double y, double width, double height, double edgeRadius, Color color, boolean topLeft, boolean topRight, boolean bottomLeft, boolean bottomRight) {
      ...
      if (topLeft) {
         ...
         rect(x, y, (double)sideLength, (double)sideLength, color);
      }
      ...
      if (bottomRight) {
         ...
         rect(x + width, y + height, (double)sideLength, (double)sideLength, color);
      }
      ...
      if (topRight) {
         ...
         rect(x + width, y, (double)sideLength, (double)sideLength, color);
      }
      ...
      if (bottomLeft) {
         ...
         rect(x, y + height, (double)sideLength, (double)sideLength, color);
      }
