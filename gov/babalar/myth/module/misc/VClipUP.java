...
/*    */   extends Module
/*    */ {
/* 15 */   public SettingNumber upValue = new SettingNumber(5.0D, 1.0D, 10.0D, 1.0D, "Value");
...
/*    */   
/*    */   public VClipUP() {
/* 21 */     super(ModuleType.MISC, "VClip Up", 200);
/* 22 */     this.abstractSettings.add(this.upValue);
...
/* 35 */           Utility.getThePlayer().e(Utility.getPosX(), Utility.getPosY() + i, Utility.getPosZ());
/* 36 */           toggle();
/*    */           return;
/*    */         } 
/*    */       } 
/*    */     } else {
/* 41 */       Utility.getThePlayer().e(Utility.getPosX(), Utility.getPosY() + this.upValue.value, Utility.getPosZ());
/*    */     } 
/* 43 */     toggle();
/*    */   }
/*    */ }
...
/* Location:              C:\Users\yavuz\Desktop\masaüstü\FlorexClient\gov.zip!\gov\babalar\myth\module\misc\VClipUP.class
